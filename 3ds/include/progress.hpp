...
// transfer modal, and pumps a frame so the UI does not freeze during a blocking
// copy. Rendering is throttled to ~64 frames per file (it knows the file size
// from startFile), which unifies the cadence the SPI restore loop used to
// hand-roll.
