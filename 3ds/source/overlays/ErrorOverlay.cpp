...
ErrorOverlay::ErrorOverlay(Screen& screen, const Backupable::ActionResult& res)
:
DualScreenOverlay(screen), button(42, 162, 236, 36, COLOR_GREY_DARKER, COLOR_WHITE, "OK", true)
{
